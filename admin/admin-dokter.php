...
<div class="page-content-wrapper border">
    ...
    <div class="row">
        <div class="col-12">
            <h1 class="h3 mb-2 mb-sm-0">Dokter</h1>
        </div>
    </div>
        ...
        <div class="card-header bg-transparent border-bottom px-0">
            ...
            <div class="row g-3 align-items-center justify-content-between">
                ...
                <?php if ($_SESSION["role"] == "1") { ?>
                    <!-- Create Dokter buttons -->
                    <div class="col-md-3">
                        <!-- Tabs START -->
                        <ul class="list-inline mb-0 nav nav-pills nav-pill-dark-soft border-0 justify-content-end" id="pills-tab" role="tablist">
                            <!-- Create Dokter -->
                            <li class="nav-item">
                                <a href="#" class="btn btn-primary-soft me-1 mb-0" data-bs-toggle="modal" data-bs-target="#modalcreatedokter">Tambah Dokter</a>
                            </li>
                        </ul>
                        <!-- Create Dokter end -->
                    </div>
                ...
                <div class="tab-pane fade show active" id="nav-html-tab-1">
                    ...
                    <div class="table-responsive border-0">
                        <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                            ...
                            <thead>
                                <tr>
                                    <th scope="col" class="border-0 rounded-start">Nama Dokter</th>
                            ...
                            <tbody>
                                ...
                                $data = mysqli_query($conn, "SELECT * FROM tbl_dokter");
                                $jumlah_data = mysqli_num_rows($data);
                                $total_halaman = ceil($jumlah_data / $batas);

                                if ($_POST["search"]) {
                                    $search = "AND full_name LIKE '%" . $_POST["search"] . "%' OR nip_dokter LIKE '%" . $_POST["search"] . "%' OR nama_spesialis LIKE '%" . $_POST["search"] . "%'";
                                }

                                $dokter = mysqli_query($conn, "SELECT * FROM tbl_dokter JOIN tbl_spesialis ON tbl_dokter.id_spesialis = tbl_spesialis.id_spesialis WHERE id_dokter " . $search . " ORDER BY full_name ASC LIMIT $halaman_awal, $batas");

                                $show_data = mysqli_num_rows($dokter);
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center position-relative">
                                                ...
                                                <div class="avatar avatar-md">
                                                    <img src="../assets/images/upload/dokter/<?= $row['profile_picture']; ?>" class="rounded-circle" alt="">
                                                </div>
                                                <div class="mb-0 ms-2">
                                                    <!-- Title -->
                                        ...
                                        <!-- Table data -->
                                        <td>
                                            <a href="#" class="btn btn-light btn-round me-1 mb-1 mb-md-0" data-bs-toggle="modal" data-bs-placement="top" data-bs-target="#modalviewdokter<?= $row['id_dokter'] ?>" title="View">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            ...
                                            <?php if ($_SESSION["role"] == "1") { ?>
                                                <a href="#" class="btn btn-success-soft btn-round me-1 mb-1 mb-md-0" data-bs-toggle="modal" data-bs-placement="top" data-bs-target="#modalupdatedokter<?= $row['id_dokter'] ?>" title="Edit">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <button class="btn btn-danger-soft btn-round mb-0" data-bs-toggle="modal" data-bs-placement="top" data-bs-target="#modaldeletedokter<?= $row['id_dokter'] ?>" title="Delete">
        ...
        <div class="card-footer bg-transparent p-0">
            ...
            <div class="d-sm-flex justify-content-sm-between align-items-sm-center">
                ...
                <p class="mb-0 text-center text-sm-start">Showing <?= $halaman_awal + 1 ?> to
                    <?= $show_data * ($next - 1) ?> of <?= $jumlah_data ?> Doctors</p>
                <!-- Pagination -->
...
<div class="modal fade" id="modalcreatedokter" tabindex="-1" aria-labelledby="createdokterlabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">

            <!-- Modal header -->
            <div class="modal-header bg-dark">
                <h5 class="modal-title text-white" id="createdokterlabel">Tambah Dokter</h5>
            ...
            <form action="../connection/function.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body p-5">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" name="nip_dokter" data-inputmask="'mask': '999999'" id="nip" type="text" placeholder="Masukkan NIP" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select js-choice border-0 z-index-9 bg-transparent" aria-label=".form-select-sm" data-search-enabled="true" name="id_spesialis" required>
                                ...
                                <?php
                                $selectspesialis = mysqli_query($conn, "SELECT * FROM tbl_spesialis WHERE kategori_spesialis=1 ORDER BY nama_spesialis ASC");
                ...
                <div class="modal-footer">
                    <input type="submit" class="btn btn-success-soft my-0" name="create_dokter" value="Save">
...
<?php
$dokter = mysqli_query($conn, "SELECT * FROM tbl_dokter JOIN tbl_spesialis ON tbl_dokter.id_spesialis = tbl_spesialis.id_spesialis ORDER BY full_name ASC");

while ($row = mysqli_fetch_assoc($dokter)) {
?>
    <!-- Modal Update Dokter START -->
    <div class="modal fade" id="modalupdatedokter<?= $row['id_dokter'] ?>" tabindex="-1" aria-labelledby="updatedokterlabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">

                <!-- Modal header -->
                <div class="modal-header bg-dark">
                    <h5 class="modal-title text-white" id="updatedokterlabel">Update Dokter</h5>
                    <button type="button" class="btn btn-sm btn-light mb-0" data-bs-dismiss="modal" aria-label="Close"><i class="bi bi-x-lg"></i></button>
                </div>
                ...
                <form action="../connection/function.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body p-5">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Mobile Number</label>
                                <input class="form-control" data-inputmask="'mask': '+6299999999999'" name="mobile_number" id="mobile_number<?= $row['id_dokter']; ?>" type="text" placeholder="Masukkan mobile number" value="<?= $row['mobile_number']; ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Spesialis</label>
                                <select class="form-select js-choice border-0 z-index-9 bg-transparent" aria-label=".form-select-sm" data-search-enabled="true" name="id_spesialis" required>
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Alamat</label>
                                <textarea class="form-control" name="alamat" rows="2" placeholder="Masukkan Alamat" required><?= $row['alamat']; ?></textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Pendidikan</label>
                            ...
                            <div class="col-md-12">
                                <label class="form-label">Deskripsi</label>
                                <textarea class="form-control" id="summernoteupdate<?= $row['id_dokter'] ?>" name="deskripsi" rows="10" placeholder="Masukkan Deskripsi"><?= $row['deskripsi']; ?></textarea>
                            </div>
                            <!-- Upload image START -->
                            <div class="col-12">
                                <div class="text-center justify-content-center align-items-center p-4 p-sm-5 border border-2 border-dashed position-relative rounded-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" name="nip_dokter" value="<?= $row['nip_dokter'] ?>">
                        <input type="submit" class="btn btn-success-soft my-0" name="update_dokter" value="Update">
                        <button type="button" class="btn btn-danger-soft my-0" data-bs-dismiss="modal">Close</button>
                    </div>
                </form>
            </div>
        ...
        <script>
            $(document).ready(function() {
                $('#summernoteupdate<?= $row['id_dokter'] ?>').summernote({
                    height: 300, // set editor height
                    focus: true // set focus to editable area after initializing summernote
                });
                $("#mobile_number<?= $row['id_dokter']; ?>").inputmask();
            });
        </script>
    </div>
    <!-- Modal Update Dokter END -->

    <!-- Modal Delete Dokter START -->
    <div class="modal fade" id="modaldeletedokter<?= $row['id_dokter'] ?>" tabindex="-1" aria-labelledby="deletedokterlabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">

                <!-- Modal header -->
                <div class="modal-header bg-dark">
                    <h5 class="modal-title text-white" id="deletedokterlabel">Data Dokter akan terhapus</h5>
                    <button type="button" class="btn btn-sm btn-light mb-0" data-bs-dismiss="modal" aria-label="Close"><i class="bi bi-x-lg"></i></button>
                </div>
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h3>Are you sure?</h3>
                    <div class="text-muted">Apakah anda benar-benar ingin menghapus dokter <span style="color:black; font-weight:bold;"><?= $row['full_name'] ?></span>? apa yang telah anda
                ...
                <form action="../connection/function.php" method="POST">
                    ...
                    <div class="modal-footer">
                        <input type="hidden" name="id_dokter" value="<?= $row['id_dokter'] ?>">
                        <input type="hidden" name="nip_dokter" value="<?= $row['nip_dokter'] ?>">
                        <input type="submit" class="btn btn-success-soft my-0" name="delete_dokter" value="Delete">
                        <button type="button" class="btn btn-danger-soft my-0" data-bs-dismiss="modal">Close</button>
                    </div>
                </form>
            </div>
    ...
    <!-- Modal Delete Dokter END -->

    <!-- Modal View Dokter START -->
    <div class="modal fade" id="modalviewdokter<?= $row['id_dokter'] ?>" tabindex="-1" aria-labelledby="viewdokterlabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">

                <!-- Modal header -->
                <div class="modal-header bg-dark">
                    <h5 class="modal-title text-white" id="viewdokterlabel"><?= $row['full_name'] ?> Detail</h5>
                    <button type="button" class="btn btn-sm btn-light mb-0" data-bs-dismiss="modal" aria-label="Close"><i class="bi bi-x-lg"></i></button>
                </div>
                ...
                <div class="modal-body p-5">
                    ...
                    <div class="position-relative">
                        <img src="../assets/images/upload/dokter/<?= $row['profile_picture']; ?>" class="rounded-circle mx-auto d-block mb-3 w-200px" alt="">
                    </div>

                    <!-- Nama Dokter -->
                    <span class="small">Nama Dokter:</span>
                    <h6 class="mb-3"><?= $row['full_name'] ?> ( <?= $row['nip_dokter'] ?>)</h6>
