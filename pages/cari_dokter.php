            ...
            <form class="bg-light border p-4 rounded-3 my-4 z-index-9 position-relative" method="POST">
                <div class="row g-3 justify-content-center">
                    ...
                    <div class="col-xl-3 col-sm-6 col-md-3 pb-2 pb-md-0">
                        <input class="form-control me-1" type="search" name="search" placeholder="Cari Dokter" value="<?= $_POST["search"] ?>">
                    </div>
                                ...
                                <div class="card shadow h-100">
                                    <div class="position-relative">
                                        ...
                                        <img src="<?php
                                                    if ($row['profile_picture'] == "") {
                                                        ...
                                                        echo "../assets/images/upload/dokter/" . $row['profile_picture'];
                                                    }
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center">
                                            <a href="#" data-bs-toggle="modal" data-bs-placement="top" data-bs-target="#modalviewdokter<?= $row['id_dokter'] ?>" title="View" class="btn btn-sm btn-primary-soft mb-0">Selengkapnya</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            if ($_SESSION['role'] == "") {
                                                ...
                                                echo '<a href="https://wa.me/' . $row['mobile_number'] . '" class="btn btn-primary-soft my-0">Buat Janji</a>';
                                            } ?>
